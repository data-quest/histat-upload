...
#Region " Vom Windows Form Designer generierter Code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'cmdAbbruch
        '
        Me.cmdAbbruch.Location = New System.Drawing.Point(16, 380)
        ...
        'cmdOK
        '
        Me.cmdOK.Location = New System.Drawing.Point(488, 380)
        Me.cmdOK.Name = "cmdOK"
        ...
        'lblDate
        '
        Me.lblDate.Location = New System.Drawing.Point(16, 340)
        ...
        Me.tbchDate.Location = New System.Drawing.Point(108, 340)
        Me.tbchDate.Name = "tbchDate"
        Me.tbchDate.Size = New System.Drawing.Size(104, 20)
        ...
        Me.tbAnzZr.Location = New System.Drawing.Point(512, 340)
        ...
        'lblZr
        '
        Me.lblZr.Location = New System.Drawing.Point(448, 340)
        Me.lblZr.Name = "lblZr"
    ...
    Private Sub cmdOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOK.Click
        Try
            If ID_Projekt = "-1" Then
                MsgBox("Bitte wählen Sie ein Projekt aus der Auswahlbox aus!", MsgBoxStyle.Exclamation, "string")
            ElseIf status = Globals.tStatus.onDelete Then
                loeschen()
            ElseIf status = Globals.tStatus.onMetadataUpdate Then
                If Me.cbProjekt.Text = "" Then
                    MsgBox("Bitte geben Sie einen Projektnamen an!", MsgBoxStyle.Exclamation, "string")
                    Exit Sub
                End If
        ...
        Catch ex As Exception
            ...
            closeForms()
            MsgBox((ex).GetType.Name & ControlChars.CrLf & ex.Message, MsgBoxStyle.Critical, "string")
        End Try
    End Sub
    ...
    Private Sub Projektauswahl_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If status = Globals.tStatus.onMetadataUpdate Then
                ...
                sSql = "SELECT ID_Projekt, Projektautor, Projektname, Projektbeschreibung, Veroeffentlichung, " & _
            ...
            Else
                sSql = "SELECT ID_Projekt, Projektautor, Projektname, Projektbeschreibung, Anzahl_Zeitreihen, exportable, chdate FROM Aka_Projekte " & _
                    "WHERE ID_Thema = " & ID_Thema & ";"
            End If
